...
const testimonials = [
  { name: "Ananya Sharma", role: "Homeowner, Bengaluru", quote: "I redesigned my entire living room before buying a single piece of furniture. Spacia saved me lakhs in design fees." },
  { name: "Rahul Mehta", role: "Interior Designer", quote: "I use Spacia to give clients instant mockups. It's become an essential part of my workflow." },
  { name: "Priya Nair", role: "Renter, Mumbai", quote: "As a renter I can't do big renovations, but Spacia helped me visualize affordable changes. Love it!" },
]
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:py-32 z-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg leading-relaxed text-muted-foreground max-w-2xl mx-auto">
              Upload a photo of your space, choose your style, and watch Spacia transform it into a stunning, photorealistic redesign. No designer required.
            </p>
      ...
      <footer className="border-t border-border bg-card/30">
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
          ...
          <div className="mt-10 border-t border-border pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Spacia. All rights reserved.</p>
