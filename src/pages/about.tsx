      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-24 text-center sm:px-6">
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Spacia was born from a simple idea: what if anyone could visualize their dream interior before spending a single rupee? We built the AI tools to make that possible.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-16 lg:grid-cols-2 items-center">
          <div>
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Hiring an interior designer costs lakhs. Buying furniture without visualizing it first is a gamble. We built Spacia to eliminate both problems — giving everyone the power to see their space transformed before committing to any changes.
            </p>
            <p className="mt-4 text-muted-foreground leading-relaxed">
